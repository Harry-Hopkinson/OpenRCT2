    ...
    switch (surfaceShape)
    {
        ...
        case 1:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::topLeft, PaintSegment::topRight), height, 0);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::centre, PaintSegment::right), height, 1);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottomLeft, PaintSegment::bottomRight), height + 6, 0x1B);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::bottom), height + 6 + 6, 0x1B);
        ...
        case 2:
            ...
            //     02
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::right, PaintSegment::topRight, PaintSegment::bottomRight), height, 0);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::centre, PaintSegment::bottom), height, 2);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::bottomLeft), height + 6, 0x17);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::left), height + 6 + 6, 0x17);
        ...
        case 3:
            ...
            //     03
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::topRight, PaintSegment::right), height + 2, 3);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::centre, PaintSegment::bottomRight), height + 2 + 6,
                3);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::bottomLeft, PaintSegment::bottom), height + 2 + 6 + 6,
                3);
        ...
        case 4:
            ...
            //     00
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottom, PaintSegment::bottomLeft, PaintSegment::bottomRight), height, 0);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::centre, PaintSegment::right), height, 4);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::topRight), height + 6, 0x1E);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::top), height + 6 + 6, 0x1E);
        ...
        case 5:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::topRight), height + 6, 0x1E);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::centre, PaintSegment::right), height, 5);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottomLeft, PaintSegment::bottomRight), height + 6, 0x1B);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::bottom), height + 6 + 6, 0x1B);
        ...
        case 6:
            ...
            //     06          ░░
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::right, PaintSegment::bottomRight, PaintSegment::bottom), height + 2, 6);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottomLeft, PaintSegment::centre, PaintSegment::topRight), height + 2 + 6,
                6);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::topLeft, PaintSegment::top), height + 2 + 6 + 6, 6);
        ...
        case 7:
            ...
            //   00  17      ▓▓  ▒▒
            //     07          ▓▓
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::right), height + 4, 0x17);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topRight, PaintSegment::bottomRight), height + 4 + 6, 0x17);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::centre, PaintSegment::bottom), height + 4 + 6 + 6, 7);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::bottomLeft, PaintSegment::left), height + 4 + 6 + 6,
                0);
        ...
        case 8:
            // Loc6620D8
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::topLeft, PaintSegment::bottomLeft), height, 0);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::centre, PaintSegment::bottom), height, 8);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topRight, PaintSegment::bottomRight), height + 6, 0x1D);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::right), height + 6 + 6, 0x1D);
        ...
        case 9:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::topLeft, PaintSegment::left), height + 2, 9);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottomLeft, PaintSegment::centre, PaintSegment::topRight), height + 2 + 6,
                9);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottom, PaintSegment::bottomRight, PaintSegment::right),
                height + 2 + 6 + 6, 9);
            break;
        ...
        case 10:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::bottomLeft), height + 6, 0x17);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::centre, PaintSegment::bottom), height, 0xA);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topRight, PaintSegment::bottomRight), height + 6, 0x1D);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::right), height + 6 + 6, 0x1D);
            break;
        ...
        case 11:
            ...
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::top), height + 4, 0x1B);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::topRight), height + 4 + 6, 0x1B);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::centre, PaintSegment::right), height + 4 + 6 + 6, 0xB);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottomLeft, PaintSegment::bottomRight, PaintSegment::bottom),
                height + 4 + 6 + 6, 0);
            break;
        ...
        case 12:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::bottomLeft, PaintSegment::bottom), height + 2, 0xC);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::centre, PaintSegment::bottomRight), height + 2 + 6,
                0xC);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::topRight, PaintSegment::right), height + 2 + 6 + 6,
                0xC);
            break;
        ...
        case 13:
            ...
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::left), height + 4, 0x1D);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::bottomLeft), height + 4 + 6, 0x1D);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::centre, PaintSegment::bottom), height + 4 + 6 + 6, 0xD);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topRight, PaintSegment::bottomRight, PaintSegment::right),
                height + 4 + 6 + 6, 0);
            break;
        ...
        case 14:
            ...
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::bottom), height + 4, 0x1E);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottomLeft, PaintSegment::bottomRight), height + 4 + 6, 0x1E);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::centre, PaintSegment::right), height + 4 + 6 + 6, 0xE);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::topRight, PaintSegment::top), height + 4 + 6 + 6,
                0);
            break;
        ...
        case 23:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topRight, PaintSegment::bottomRight), height + 4 + 6, 0x17);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::top, PaintSegment::centre, PaintSegment::bottom), height + 4 + 6 + 6,
                0x17);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::bottomLeft), height + 4 + 6 + 6 + 6, 0x17);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::left), height + 4 + 6 + 6 + 6 + 6, 0x17);
            break;
        ...
        case 27:
            ...
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::topRight), height + 4 + 6, 0x1B);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::left, PaintSegment::centre, PaintSegment::right), height + 4 + 6 + 6,
                0x1B);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::bottomLeft, PaintSegment::bottomRight), height + 4 + 6 + 6 + 6, 0x1B);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::bottom), height + 4 + 6 + 6 + 6 + 6, 0x1B);
            break;
        ...
        case 29:
            ...
            PaintUtilSetSegmentSupportHeight(
                ...
                0x1D);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topRight, PaintSegment::bottomRight), height + 4 + 6 + 6 + 6, 0x1D);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::right), height + 4 + 6 + 6 + 6 + 6, 0x1D);
            break;
        ...
        case 30:
            ...
            PaintUtilSetSegmentSupportHeight(
                ...
                0x1E);
            PaintUtilSetSegmentSupportHeight(
                session, PaintSegments(PaintSegment::topLeft, PaintSegment::topRight), height + 4 + 6 + 6 + 6, 0x1E);
            PaintUtilSetSegmentSupportHeight(session, PaintSegments(PaintSegment::top), height + 4 + 6 + 6 + 6 + 6, 0x1E);
            break;
    }
}
