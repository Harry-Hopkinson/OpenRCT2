...
static constexpr const uint32_t MultidimDiagBrakeImages[kNumOrthogonalDirections] = {
...
static constexpr const uint32_t MultidimDiagBlockBrakeImages[2][kNumOrthogonalDirections] = {
    {
