    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    ChairliftPaintUtilDrawSupports(session, PaintSegments(PaintSegment::centre), height, supportType);
    PaintUtilSetSegmentSupportHeight(session, kSegmentsAll, 0xFFFF, 0);
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    ChairliftPaintUtilDrawSupports(
        session, PaintUtilRotateSegments(PaintSegments(PaintSegment::topLeft, PaintSegment::bottomLeft), direction), height,
        supportType);
