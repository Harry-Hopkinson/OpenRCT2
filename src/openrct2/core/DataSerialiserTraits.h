...
namespace OpenRCT2
{
    ...
    template<>
    struct DataSerializerTraitsT<Network::PlayerId_t>
    {
        ...
        static void log(IStream* stream, const Network::PlayerId_t& val)
        {
            ...
            int32_t playerIndex = Network::GetPlayerIndex(val.id);
            if (playerIndex != -1)
            {
                const char* playerName = Network::GetPlayerName(playerIndex);
    ...
    template<>
    struct DataSerializerTraitsT<MemoryStream>
    {
    ...
    template<size_t _Size>
    struct DataSerializerTraitsT<Drawing::Colour[_Size]> : public DataSerializerTraitsPODArray<Drawing::Colour, _Size>
    {
    };
    ...
    template<>
    struct DataSerializerTraitsT<Network::CheatType_t>
    {
    ...
    struct DataSerializerTraitsT<RCTObjectEntry>
    {
        ...
        static void log(IStream* stream, const RCTObjectEntry& val)
        {
    ...
    struct DataSerializerTraitsT<ObjectEntryDescriptor>
    {
        ...
        static void log(IStream* stream, const ObjectEntryDescriptor& val)
        {
    ...
    {
        static void encode(IStream* stream, const VehicleColour& val)
        {
            stream->WriteValue(val.Body);
            stream->WriteValue(val.Trim);
            stream->WriteValue(val.Tertiary);
        }
        static void decode(IStream* stream, VehicleColour& val)
        {
            stream->ReadValue(val.Body);
            stream->ReadValue(val.Trim);
            stream->ReadValue(val.Tertiary);
        }
        static void log(IStream* stream, const VehicleColour& val)
        {
            char msg[128] = {};
            snprintf(
                msg, sizeof(msg), "VehicleColour(Body = %d, Trim = %d, Tertiary = %d)", EnumValue(val.Body),
                EnumValue(val.Trim), EnumValue(val.Tertiary));
            stream->Write(msg, strlen(msg));
        }
    };

    template<>
    struct DataSerializerTraitsT<RideRating::Tuple>
    {
        static void encode(IStream* stream, const RideRating::Tuple& val)
        {
            stream->WriteValue(val.excitement);
            stream->WriteValue(val.intensity);
            stream->WriteValue(val.nausea);
        }
        static void decode(IStream* stream, RideRating::Tuple& val)
        {
            stream->ReadValue(val.excitement);
            stream->ReadValue(val.intensity);
            stream->ReadValue(val.nausea);
        }
        static void log(IStream* stream, const RideRating::Tuple& val)
        {
            char msg[128] = {};
            snprintf(
                msg, sizeof(msg), "RideRating::Tuple(excitement = %d, intensity = %d, nausea = %d)", val.excitement,
    ...
    {
        static void encode(IStream* stream, const IntensityRange& val)
        {
            stream->WriteValue(static_cast<uint8_t>(val));
        }
        static void decode(IStream* stream, IntensityRange& val)
        {
    ...
    {
        static void encode(IStream* stream, const PeepThought& val)
        {
            stream->WriteValue(val.type);
        ...
        static void decode(IStream* stream, PeepThought& val)
        {
            stream->ReadValue(val.type);
        ...
        static void log(IStream* stream, const PeepThought& val)
        {
            char msg[128] = {};
            snprintf(
    ...
    struct DataSerializerTraitsT<TileCoordsXYZD>
    {
        ...
        static void log(IStream* stream, const TileCoordsXYZD& coord)
        {
            char msg[128] = {};
            snprintf(
    ...
    struct DataSerializerTraitsT<Banner>
    {
        ...
        static void log(IStream* stream, const Banner& banner)
        {
            char msg[128] = {};
            snprintf(
    ...
    {
        static void encode(IStream* stream, const FootpathSlope& slope)
        {
            uint8_t combined = (EnumValue(slope.type) << 2) | (slope.direction % kNumOrthogonalDirections);
            stream->WriteValue(combined);
        }

        static void decode(IStream* stream, FootpathSlope& slope)
        {
        ...
        static void log(IStream* stream, const FootpathSlope& slope)
        {
            char msg[128] = {};
