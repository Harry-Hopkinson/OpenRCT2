...
namespace OpenRCT2
{
    ...
    constexpr uint16_t kMaxStationLocations = Limits::kMaxStationsPerRide * 2; // Entrance and exit per station
    ...
    struct Ride
    {
        ...
        VehicleColour vehicleColours[Limits::kMaxVehicleColours]{};
        // 0 = closed, 1 = open, 2 = test
        RideStatus status{};
        std::string customName;
        uint16_t defaultNameNumber{};
        CoordsXY overallView;
        EntityId vehicles[Limits::kMaxTrainsPerRide + 1]{}; // Points to the first car in the train
        uint8_t departFlags{};
        uint8_t numStations{};
        uint8_t numTrains{};
        ...
        uint16_t numCustomers[Limits::kCustomerHistorySize]{};
        ...
        Drawing::Colour slidePeepTShirtColour{};
        ...
        uint8_t downtimeHistory[Limits::kDowntimeHistorySize]{};
    ...
    public:
        ...
        // Returns the logical station number from the given station. Index 0 = station 1, index 1 = station 2. It accounts for
        // gaps in the station array. e.g. if only slot 0 and 2 are in use, index 2 returns 2 instead of 3.
    ...
    public:
        ...
        void removeVehicles();
        /**
         * Updates all pieces of the ride to match the internal ride type. (Track pieces can have different ride types from the
         * ride they belong to, to enable “merging”.)
         */
