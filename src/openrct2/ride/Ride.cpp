    ...
    money64 Ride::calculateIncomePerHour() const
    {
        ...
        if (currentShopItem != ShopItem::none)
        {
            ...
            if (GetShopItemDescriptor(currentShopItem).IsPhoto())
            {
                ...
                // Use the ratio between photo sold and total admissions to approximate the photo income(as not every guest will
                // buy one).
            ...
            && ride.flags.has(RideFlag::breakdownPending) && !ride.flags.has(RideFlag::brokenDown))
        {
                ...
                || breakdownReason == Breakdown::controlFailure)
            {
                ...
                ride.windowInvalidateFlags.set(
                    RideInvalidateFlag::maintenance, RideInvalidateFlag::list, RideInvalidateFlag::main);
...
#pragma endregion
            ...
            if (tileElement != nullptr)
            {
                do
                {
                    ...
                    FootpathChainRideQueue(
                        id, getStationIndex(&station), mapLocation, tileElement, DirectionReverse(direction));
                } while (!(tileElement++)->isLastForTile());
            }
        }
    }
    ...
    static bool RideCheckStartAndEndIsStation(const CoordsXYE& input)
    {
        ...
        ride->chairliftBullwheelLocation[0] = TileCoordsXYZ{ CoordsXYZ{ trackBack.x, trackBack.y,
                                                                        trackBack.element->getBaseZ() } };
    ...
    /**
     * Sets the position and direction of the returning point on the track of a boat hire ride. This will either be the end of
     * the station or the last track piece from the end of the direction. rct2: 0x006B4D39
     */
    ...
    void Ride::moveTrainsToBlockBrakes(const CoordsXYZ& firstBlockPosition, TrackElement& firstBlock)
    {
        ...
        for (int32_t i = 0; i < numTrains; i++)
        {
            ...
            do
            {
                ...
                // Setting the first block before the cable lift to the same state as the cable lift ensures that any train
                // which would be placed on the cable lift will instead stop on the block before it. As there can only be one
                // cable lift per ride and there must always be at least one block left free, there will be enough blocks
        ...
        while (trackCircuitIteratorPrevious(&it))
        {
            ...
            switch (trackType)
            {
                ...
                case TrackElemType::flat:
                    ...
                    {
                        GetTrackElementOriginAndApplyChanges(
                            { { it.current, tileElement->getBaseZ() }, tileElement->getDirection() }, trackType, 0,
                            &tileElement, { TrackElementSetFlag::cableLiftOn });
                    }
                    break;
                case TrackElemType::endStation:
                case TrackElemType::blockBrakes:
    ...
    void Ride::setColourPreset(uint8_t trackColourPreset, uint8_t vehicleColourPreset)
    {
        ...
        TrackColour colours = { Drawing::Colour::black, Drawing::Colour::black, Drawing::Colour::black };
    ...
    BitSet<EnumValue(TrackGroup::count)> RideEntryGetSupportedTrackPieces(const RideObjectEntry& rideEntry)
    {
        ...
        static const std::array<NecessarySpriteGroup, 9> trackPieceRequiredSprites[] = {
            ...
            { SpriteGroupType::flatBanked22, SpritePrecision::sprites4, SpriteGroupType::flatBanked45,
              SpritePrecision::sprites4, SpriteGroupType::flatBanked67, SpritePrecision::sprites4,
              SpriteGroupType::flatBanked90, SpritePrecision::sprites4, SpriteGroupType::inlineTwists,
              SpritePrecision::sprites4, SpriteGroupType::slopeInverted, SpritePrecision::sprites4 }, // TrackGroup::twist
            { SpriteGroupType::slopes60, SpritePrecision::sprites4, SpriteGroupType::slopes75, SpritePrecision::sprites4,
              SpriteGroupType::slopes90, SpritePrecision::sprites4, SpriteGroupType::slopesLoop, SpritePrecision::sprites4,
            ...
            { SpriteGroupType::flatBanked22, SpritePrecision::sprites4, SpriteGroupType::flatBanked45,
              SpritePrecision::sprites4, SpriteGroupType::inlineTwists, SpritePrecision::sprites4,
              SpriteGroupType::slopeInverted, SpritePrecision::sprites4 }, // TrackGroup::barrelRoll
            ...
            { SpriteGroupType::flatBanked22, SpritePrecision::sprites4, SpriteGroupType::flatBanked45,
              SpritePrecision::sprites4, SpriteGroupType::inlineTwists, SpritePrecision::sprites4,
              SpriteGroupType::slopeInverted, SpritePrecision::sprites4 }, // TrackGroup::heartlineRoll
            ...
            { SpriteGroupType::flatBanked22, SpritePrecision::sprites4, SpriteGroupType::flatBanked45,
              SpritePrecision::sprites4, SpriteGroupType::flatBanked67, SpritePrecision::sprites4,
              SpriteGroupType::flatBanked90, SpritePrecision::sprites4, SpriteGroupType::inlineTwists,
              SpritePrecision::sprites4, SpriteGroupType::slopeInverted,
            ...
            { SpriteGroupType::slopes25, SpritePrecision::sprites4, SpriteGroupType::slopes12Banked22,
              SpritePrecision::sprites4, SpriteGroupType::slopes25Banked22, SpritePrecision::sprites4,
              SpriteGroupType::slopes25Banked45, SpritePrecision::sprites4, SpriteGroupType::inlineTwists,
              SpritePrecision::sprites4, SpriteGroupType::slopeInverted, SpritePrecision::sprites4 }, // TrackGroup::zeroGRoll
            ...
            { SpriteGroupType::slopes50, SpritePrecision::sprites4, SpriteGroupType::slopes60Banked22,
              SpritePrecision::sprites8, SpriteGroupType::slopes50Banked45, SpritePrecision::sprites8,
              SpriteGroupType::slopes50Banked67, SpritePrecision::sprites8, SpriteGroupType::slopes50Banked90,
              SpritePrecision::sprites8, SpriteGroupType::corkscrews, SpritePrecision::sprites4,
              SpriteGroupType::slopes25InlineTwists, SpritePrecision::sprites4, SpriteGroupType::slopesLoop,
              SpritePrecision::sprites4, SpriteGroupType::slopeInverted, SpritePrecision::sprites4 }, // TrackGroup::diveLoop
        ...
        // exception, at least)
        auto supportedPieces = BitSet<EnumValue(TrackGroup::count)>();
    ...
    {
        auto rideSetVehicleAction = GameActions::RideSetVehicleAction(
            id, GameActions::RideSetVehicleType::numTrains, newNumTrains);
        GameActions::Execute(&rideSetVehicleAction, getGameState());
    }
