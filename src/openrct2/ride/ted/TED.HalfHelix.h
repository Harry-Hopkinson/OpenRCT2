...
namespace OpenRCT2::TrackMetadata
{
    ...
    static constexpr SequenceDescriptor kLeftHalfBankedHelixUpSmallSeq0 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::top, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft), // narrow
    ...
    static constexpr SequenceDescriptor kLeftHalfBankedHelixUpSmallSeq3 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::bottomLeft, PS::bottomRight), // narrow
            kSegmentsUnimplemented,                                                              // inverted
            kSegmentsAll,                                                                        // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftHalfBankedHelixUpSmallSeq4 = {
        ...
        .extraSupportRotation = -1,
        .blockedSegments = { {
            PaintSegments(PS::left, PS::centre, PS::topLeft, PS::bottomLeft, PS::bottomRight), // narrow
            kSegmentsUnimplemented,                                                            // inverted
            kSegmentsAll,                                                                      // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftHalfBankedHelixUpSmallSeq6 = {
        ...
        .blockedSegments = { {
            ...
            kSegmentsUnimplemented,                                                 // inverted
            PaintSegments(PS::bottom, PS::centre, PS::bottomLeft, PS::bottomRight), // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftHalfBankedHelixUpLargeSeq2 = {
        ...
        .blockedSegments = { {
            ...
            kSegmentsUnimplemented,                                                                  // inverted
            PaintSegments(PS::top, PS::left, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft), // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftHalfBankedHelixUpLargeSeq5 = {
        ...
        .blockedSegments = { {
            ...
            kSegmentsUnimplemented,                                                                        // inverted
            PaintSegments(PS::left, PS::bottom, PS::centre, PS::topLeft, PS::bottomLeft, PS::bottomRight), // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftHalfBankedHelixUpLargeSeq8 = {
        ...
        .blockedSegments = { {
            kSegmentsNone,                                     // narrow
            kSegmentsUnimplemented,                            // inverted
            PaintSegments(PS::top, PS::topLeft, PS::topRight), // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftHalfBankedHelixUpLargeSeq12 = {
        ...
        .blockedSegments = { {
            ...
            kSegmentsUnimplemented,                                                                          // inverted
            PaintSegments(PS::right, PS::bottom, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // wide
        } },
    };
