...
namespace OpenRCT2::TrackMetadata
{
    ...
    constexpr BlockedSegmentsPerType kFlatStraightBlockedSegments = { {
        PaintSegments(PaintSegment::centre, PaintSegment::topRight, PaintSegment::bottomLeft), // narrow
        PaintSegments(PaintSegment::centre, PaintSegment::topRight, PaintSegment::bottomLeft), // inverted
        kSegmentsAll,                                                                          // wide
    } };
