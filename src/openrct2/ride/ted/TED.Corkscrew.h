...
namespace OpenRCT2::TrackMetadata
{
    ...
    static constexpr SequenceDescriptor kLeftCorkscrewUpSeq2 = {
        ...
        .blockedSegments = { {
            ...
            PaintSegments(PS::top, PS::right, PS::bottom, PS::centre, PS::topLeft, PS::topRight, PS::bottomRight), // inverted
            kSegmentsUnimplemented,                                                                                // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kRightCorkscrewUpSeq2 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::left, PS::centre, PS::topLeft, PS::bottomLeft, PS::bottomRight),                   // narrow
            PaintSegments(PS::top, PS::left, PS::right, PS::centre, PS::topLeft, PS::topRight, PS::bottomRight), // inverted
            kSegmentsUnimplemented,                                                                              // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftFlyerCorkscrewDownSeq0 = {
        ...
        .blockedSegments = { {
            ...
            PaintSegments(PS::top, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft), // inverted
            kSegmentsUnimplemented,                                                        // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftFlyerCorkscrewDownSeq2 = {
        ...
        .blockedSegments = { {
            kSegmentsUnimplemented,                                                              // narrow
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::bottomLeft, PS::bottomRight), // inverted
            kSegmentsUnimplemented,                                                              // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kRightFlyerCorkscrewDownSeq0 = {
        ...
        .blockedSegments = { {
            kSegmentsUnimplemented,                                                               // narrow
            PaintSegments(PS::bottom, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // inverted
            kSegmentsUnimplemented,                                                               // wide
        } },
    };
