...
namespace OpenRCT2::TrackMetadata
{
    ...
    static constexpr SequenceDescriptor kFlyerHalfLoopUninvertedUpSeq2 = {
        ...
        .invertSegmentBlocking = true,
        .blockedSegments = { {
            PaintSegments(PS::left, PS::bottom, PS::centre, PS::bottomLeft, PS::topLeft, PS::bottomRight), // narrow
            PaintSegments(PS::left, PS::bottom, PS::centre, PS::bottomLeft, PS::topLeft, PS::bottomRight), // inverted
            kSegmentsUnimplemented,                                                                        // wide
        } },
    };
