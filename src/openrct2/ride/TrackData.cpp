...
#pragma region trackBlocks
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn5TilesSeq0 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::top, PS::centre, PS::topRight, PS::bottomLeft),                  // narrow
            PaintSegments(PS::top, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // inverted
            kSegmentsAll,                                                                      // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn5TilesSeq1 = {
        ...
        .blockedSegments = { {
            ...
            PaintSegments(PS::right, PS::topRight, PS::bottomRight), // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn5TilesSeq2 = {
        ...
        .blockedSegments = blockedSegmentsAllTypes(
            PaintSegments(PS::top, PS::left, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft)),
    };
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn5TilesSeq3 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::right, PS::centre, PS::topRight, PS::bottomRight), // narrow
            PaintSegments(PS::right, PS::centre, PS::topRight, PS::bottomRight), // inverted
            PaintSegments(
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn5TilesSeq5 = {
        ...
        .extraSupportRotation = -1,
        .blockedSegments = blockedSegmentsAllTypes(
            PaintSegments(PS::left, PS::bottom, PS::centre, PS::topLeft, PS::bottomLeft, PS::bottomRight)),
    };
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn5TilesSeq6 = {
        ...
        .extraSupportRotation = -1,
        .blockedSegments = { {
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::bottomRight),               // narrow
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::topRight, PS::bottomRight), // inverted
            kSegmentsAll,                                                                      // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kFlatToLeftBankSeq0 = {
        ...
        .metalSupports = { MetalSupportPlace::centre, true },
        .blockedSegments = { {
            PaintSegments(PS::centre, PS::topRight, PS::bottomLeft),                                         // narrow
            PaintSegments(PS::right, PS::bottom, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // inverted
            kSegmentsAll,                                                                                    // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn3TilesSeq2 = {
        ...
        .allowedWallEdges = 0b0011,
        .blockedSegments = blockedSegmentsAllTypes(PaintSegments(PS::left, PS::centre, PS::topLeft, PS::bottomLeft)),
    };
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn3TilesUp25Seq2 = {
        ...
        .blockedSegments = { {
            kSegmentsNone,                                                    // narrow
            kSegmentsNone,                                                    // inverted
            PaintSegments(PS::left, PS::centre, PS::topLeft, PS::bottomLeft), // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn1TileSeq0 = {
        ...
        .metalSupports = { MetalSupportPlace::centre },
        .blockedSegments = { {
            PaintSegments(PS::left, PS::centre, PS::topLeft, PS::bottomLeft), // narrow
            PaintSegments(PS::left, PS::centre, PS::topLeft, PS::bottomLeft), // inverted
            kSegmentsAll,                                                     // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftTwistDownToUpSeq0 = {
        ...
        .metalSupports = { MetalSupportPlace::centre },
        .blockedSegments = { {
            PaintSegments(PS::top, PS::left, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft),         // narrow
            PaintSegments(PS::right, PS::bottom, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // inverted
    ...
    static constexpr SequenceDescriptor kLeftQuarterBankedHelixLargeUpSeq0 = {
        ...
        .metalSupports = { MetalSupportPlace::centre },
        .blockedSegments = { {
            PaintSegments(PS::top, PS::centre, PS::topRight, PS::bottomLeft, PS::topLeft, PS::left), // narrow
            PaintSegments(PS::top, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight),       // inverted
            kSegmentsAll,                                                                           // wide
        } },
    ...
    static constexpr SequenceDescriptor kLeftQuarterBankedHelixLargeUpSeq2 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::top, PS::left, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft), // narrow
            PaintSegments(PS::top, PS::left, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft), // inverted
            PaintSegments(
    ...
    static constexpr SequenceDescriptor kLeftQuarterBankedHelixLargeUpSeq3 = {
        ...
        .woodenSupports = { WoodenSupportSubType::corner1 },
        .blockedSegments = { {
            PaintSegments(PS::right, PS::centre, PS::topRight, PS::bottomRight, PS::bottom, PS::top), // narrow
            PaintSegments(PS::right, PS::centre, PS::topRight, PS::bottomRight),                      // inverted
            PaintSegments(
                PS::top, PS::right, PS::bottom, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft,
                PS::bottomRight), // wide
    ...
    static constexpr SequenceDescriptor kLeftQuarterBankedHelixLargeUpSeq5 = {
        ...
        .extraSupportRotation = -1,
        .blockedSegments = { {
            PaintSegments(PS::left, PS::bottom, PS::centre, PS::topLeft, PS::bottomLeft, PS::bottomRight), // narrow
            PaintSegments(PS::left, PS::bottom, PS::centre, PS::topLeft, PS::bottomLeft, PS::bottomRight), // inverted
            PaintSegments(
    ...
    static constexpr SequenceDescriptor kLeftQuarterBankedHelixLargeUpSeq6 = {
        ...
        .extraSupportRotation = -1,
        .blockedSegments = { {
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::bottomRight, PS::bottomLeft, PS::left), // narrow
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::topRight, PS::bottomRight),             // inverted
            kSegmentsAll,                                                                                 // wide
        } },
    ...
    static constexpr SequenceDescriptor kLeftQuarterHelixLargeUpSeq0 = {
        ...
        .metalSupports = { MetalSupportPlace::centre },
        .blockedSegments = { {
            PaintSegments(PS::top, PS::centre, PS::topRight, PS::bottomLeft, PS::topLeft),     // narrow
            PaintSegments(PS::top, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // inverted
            kSegmentsAll,                                                                      // wide
        } },
    ...
    static constexpr SequenceDescriptor kLeftQuarterHelixLargeUpSeq6 = {
        ...
        .extraSupportRotation = -1,
        .blockedSegments = { {
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::bottomRight, PS::bottomLeft), // narrow
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::topRight, PS::bottomRight),   // inverted
            kSegmentsAll,                                                                        // wide
        } },
    ...
    static constexpr SequenceDescriptor kLeftEighthToDiagSeq0 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::centre, PS::topRight, PS::bottomLeft), // narrow
            PaintSegments(PS::centre, PS::topRight, PS::bottomLeft), // inverted
            kSegmentsAll,                                            // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftEighthToDiagSeq2 = {
        ...
        .woodenSupports = { WoodenSupportSubType::corner1 },
        .blockedSegments = { {
            PaintSegments(PS::right, PS::bottom, PS::centre, PS::topRight, PS::bottomRight), // narrow
            PaintSegments(PS::right, PS::bottom, PS::centre, PS::topRight, PS::bottomRight), // inverted
            kSegmentsAll,                                                                    // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftEighthToDiagSeq4 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft, PS::bottomRight), // narrow
            PaintSegments(PS::bottom, PS::centre, PS::topLeft, PS::topRight, PS::bottomLeft, PS::bottomRight), // inverted
            kSegmentsAll,                                                                                      // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftEighthBankToDiagSeq0 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::centre, PS::topRight, PS::bottomLeft),                  // narrow
            PaintSegments(PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // inverted
            kSegmentsAll,                                                             // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kDiagFlatSeq1 = {
        ...
        .woodenSupports = { WoodenSupportSubType::corner0 },
        .blockedSegments = { {
            PaintSegments(PS::top, PS::centre, PS::topLeft, PS::topRight), // narrow
            PaintSegments(PS::top, PS::centre, PS::topLeft, PS::topRight), // inverted
            kSegmentsAll,                                                  // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kDiagFlatSeq2 = {
        ...
        .woodenSupports = { WoodenSupportSubType::corner2 },
        .blockedSegments = { {
            PaintSegments(PS::bottom, PS::centre, PS::bottomLeft, PS::bottomRight), // narrow
            PaintSegments(PS::bottom, PS::centre, PS::bottomLeft, PS::bottomRight), // inverted
            kSegmentsAll,                                                           // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kDiagFlatToLeftBankSeq3 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::left, PS::centre, PS::topLeft, PS::bottomLeft),             // narrow
            PaintSegments(PS::left, PS::bottom, PS::centre, PS::topLeft, PS::bottomLeft), // inverted
            kSegmentsAll,                                                                 // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kDiagFlatToRightBankSeq3 = {
        ...
        .blockedSegments = { {
            PaintSegments(PS::left, PS::centre, PS::topLeft, PS::bottomLeft),          // narrow
            PaintSegments(PS::top, PS::left, PS::centre, PS::topLeft, PS::bottomLeft), // inverted
            kSegmentsAll,                                                              // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftBarrelRollUpToDownSeq0 = {
        ...
        .woodenSupports = { WoodenSupportSubType::neSw },
        .blockedSegments = { {
            PaintSegments(PS::right, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // narrow
            kSegmentsUnimplemented,                                                              // inverted
            kSegmentsAll,                                                                        // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftBarrelRollUpToDownSeq1 = {
        ...
        .woodenSupports = { WoodenSupportSubType::neSw },
        .blockedSegments = { {
            PaintSegments(PS::right, PS::bottom, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // narrow
            kSegmentsUnimplemented,                                                                          // inverted
            kSegmentsAll,                                                                                    // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftBarrelRollUpToDownSeq2 = {
        ...
        .invertSegmentBlocking = true,
        .blockedSegments = { {
            PaintSegments(PS::bottom, PS::centre, PS::topRight, PS::bottomLeft, PS::bottomRight), // narrow
            kSegmentsUnimplemented,                                                               // inverted
            kSegmentsAll,                                                                         // wide
        } },
    };
    ...
    static constexpr SequenceDescriptor kLeftQuarterTurn1TileDown90Seq0 = {
        ...
        .flags = { SequenceFlag::hasHeightMarker },
        .blockedSegments = { {
            PaintSegments(PS::centre, PS::topLeft, PS::bottomRight), // narrow
            PaintSegments(PS::centre, PS::topLeft, PS::bottomRight), // inverted
            kSegmentsAll,                                            // wide
        } },
    };
